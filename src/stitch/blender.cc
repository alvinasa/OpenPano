...
void LinearBlender::add_image(const Coor &upper_left, const Coor &bottom_right,
                              ImageRef &img,
...
#define GET_COLOR_AND_W                                                        \
    ...
    if (LAZY_READ) {
        // use weighted pixel, to iterate over images (and free them) instead of
        // target will be a little bit slower
